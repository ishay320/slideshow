#ifndef INLINE_LOGGER_H
#define INLINE_LOGGER_H
#include <iostream>
...
#define LOG_DEBUG(...) std::cout << "\033[34m" << __FILE__ << ':' << __LINE__ << " " << __FUNCTION__ << " [DEBUG] \033[0m" << __VA_ARGS__ << "\n"

#endif // INLINE_LOGGER_H